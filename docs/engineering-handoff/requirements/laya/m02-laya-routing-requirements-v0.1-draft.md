...
状态：DRAFT / SCOPE INCLUDED IN M02; PENDING PRIORITY, CONTRACT AND ARCHITECTURE REVIEW
日期：2026-09-23（Asia/Shanghai）
适用基线：[M02 Requirement Baseline v0.2 Candidate](../requirement-baseline-m02-v0.2-candidate.md)（M02-LAYA-001 独立工作流）
设计提案：[M02 Laya 模型路由决策模块提案 v0.2](./m02-laya-routing-architecture-v0.2-proposal.md)

产品范围决定已确认将 Laya 辅助的语义模型路由独立纳入 M02。本文细化其需求候选，仍不是已批准 API Contract、数据库设计、优先级或开发授权。M01 仍保持冻结。
...
| 编号 | 待确认事项 | 负责人建议 |
| --- | --- | --- |
| ROUTE-OPEN-001 | 已确认纳入 M02 独立工作流；其优先级是 P0、P1 或分阶段 POC/production Gate | 产品负责人 |
