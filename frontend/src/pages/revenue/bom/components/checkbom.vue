      ...
      <div v-if="!editBomShow && !historyParentId_" class="app-container">
        ...
        <div class="mb20">
          ...
          <el-button
            ...
            >{{ bomCalculating ? "计算中" : "计算" }}</el-button
          >
          <Columns
            v-if="columns.length"
        ...
        >
          ...
          <el-table-column
            ...
            prop="serialNumber"
          ></el-table-column>
          <el-table-column v-if="setShow(1)" align="center" label="基本信息">
            <el-table-column
              v-if="setShow(1, 0)"
              align="center"
              label="零件号"
          ...
          <el-table-column v-if="setShow(2)" label="分类" align="center">
            <el-table-column
              v-if="setShow(2, 0)"
              align="center"
              label="通用化级别"
          ...
          <el-table-column v-if="setShow(3)" label="BOM补充信息" align="center">
            <el-table-column
              v-if="setShow(3, 0)"
              align="center"
              label="建议货源"
          ...
          <el-table-column v-if="setShow(4)" label="分工" align="center">
            <el-table-column
              v-if="setShow(4, 0)"
              align="center"
              label="研发专业部门"
          ...
          <el-table-column v-if="setShow(5)" label="单车用量" align="center">
          ...
          <el-table-column v-if="setShow(6)" label="目标成本" align="center">
            <el-table-column
              v-if="setShow(6, 0)"
              align="center"
              label="目标-材料成本（不含摊销）"
          ...
          <el-table-column v-if="setShow(7)" label="评估成本" align="center">
            <el-table-column
              v-if="setShow(7, 0)"
              align="center"
              label="评估-材料成本（不含摊销）"
          ...
          <el-table-column v-if="setShow(8)" label="当前成本" align="center">
            <el-table-column
              v-if="setShow(8, 0)"
              align="center"
              label="当前-材料成本（含摊销）"
          ...
          <el-table-column v-if="setShow(13)">
            <el-table-column
              v-if="setShow(13, 0)"
              align="center"
              label="当前版本"
...
import { Search, Refresh, Tickets, Clock, Edit, Upload } from "@element-plus/icons-vue";
import { BaseToast } from "@/components/base/BaseToast";
import { bomListTwo, costCalculate, getCalculatingStatus } from "@/api/revenue";
...
function resetForm() {
  ...
  searchForm.value.bomVersionId = props.params_.bomVersionId;
  searchForm.value.version = props.params_.version || "";
  getList();
}
...
function handleExport() {
  ...
  const { vehicleModelName, valveName } = props.params_;
  downloadPost(
    "system/bom/export",
    ids,
...
// ===== 初始化 =====
onMounted(() => {
  getCalculatingStatus(props.params_.bomVersionId).then((res: any) => {
    if (res.data == false) {
      bomCalculating.value = false;
    }
    if (res.data == true) {
  ...
  searchForm.value.bomVersionId = props.params_.bomVersionId;
  searchForm.value.version = props.params_.version || "";
  page.vehicleModelName = props.params_.vehicleModelName;
  page.valveName = props.params_.valveName;
  getList();
});
